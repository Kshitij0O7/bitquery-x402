// x402 Client Bundle for Browser
...
// node_modules/@x402/core/dist/esm/chunk-3IUBYRYG.mjs
...
// node_modules/@x402/core/dist/esm/chunk-XT4E3FX4.mjs
...
function wrapFetchWithPayment(fetch2, client) {
  ...
  return async (input, init) => {
    const response = await fetch2(input, init);
    ...
    const secondResponse = await fetch2(input, newInit);
...
var ExactEvmScheme = class {
  ...
  async signAuthorization(authorization, requirements) {
    ...
    const { name, version: version2 } = requirements.extra;
    const domain = {
      name,
      version: version2,
      chainId,
...
// public/x402-client.js
var x402ClientInstance = null;
var fetchWithPayment = null;
function initializeX402Client(privateKey) {
  try {
...
async function makePaidRequest(url, options, sendPayment = true) {
  if (!sendPayment) {
